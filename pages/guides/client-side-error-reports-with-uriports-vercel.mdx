...
export const meta = {
  ...
  lastEdited: '2020-08-11T20:32:53.000Z',
}
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-error-reports-with-uriports-vercel/uriports.png`}
  width={2192 / 2.25}
  height={1312 / 2.25}
  oversize
  shadow
...
For projects that were deployed from a Git repository, all you need is to push to the [Production Branch](/docs/v2/git-integrations#production-branch) (commonly `main`) and you will get a fresh Production Deployment.
