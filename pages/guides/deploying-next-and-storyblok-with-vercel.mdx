...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-storyblok-with-vercel/creating-entry.png`}
  width={1390 / 2}
  height={521 / 2}
  oversize
  shadow
/>
<Caption>
  Creating an Entry for your Next.js + Storyblok project using the Storyblok
  Content Dashboard.
</Caption>
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-storyblok-with-vercel/define-schema.png`}
  width={867 / 2}
  height={437 / 2}
  oversize
  shadow
/>
<Caption>
  Defining a <b>Post Schema</b> for your Next.js + Storyblok project.
</Caption>
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-storyblok-with-vercel/defined-schema.png`}
  width={830 / 2}
  height={602 / 2}
  oversize
  shadow
/>
<Caption>
  An example <b>Post Schema</b> for your Next.js + Storyblok project.
</Caption>
...
<Snippet
  width="100%"
  dark
  text="mkdir my-nextjs-storyblok-project && cd my-nextjs-storyblok-project"
/>
...
<Caption>
  Adding <InlineCode>next</InlineCode>, <InlineCode>react</InlineCode> and{' '}
  <InlineCode>react-dom</InlineCode> as dependencies to your project.
</Caption>
  ...
  useEffect(() => {
    async function getPosts() {
      const res = await fetch(
        `https://api.storyblok.com/v1/cdn/stories?token=${process.env.API_TOKEN}`
      )
...
<Snippet
  width="100%"
  dark
  text="vercel secrets add STORYBLOK_API_TOKEN your-api-token"
/>
<Caption>
  Adding the <InlineCode>STORYBLOK_API_TOKEN</InlineCode> secret to your project
